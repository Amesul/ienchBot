...
const { token, clientId, mongoPath } = require("./config.json");

let database;
var MongoClient = require("mongodb").MongoClient;
var uri =
  "mongodb://discord:sam010201SAM@cluster0-shard-00-00.wtw8u.mongodb.net:27017,cluster0-shard-00-01.wtw8u.mongodb.net:27017,cluster0-shard-00-02.wtw8u.mongodb.net:27017/?ssl=true&replicaSet=atlas-1ykgx1-shard-0&authSource=admin&retryWrites=true&w=majority";
...
for (const folder of commandFolders) {
  ...
  for (const file of commandFiles) {
    ...
    if (folder == "utility")
      bot.commandsutility.set(command.data.name, command);
